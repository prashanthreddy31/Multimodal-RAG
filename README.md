...
A Multimodal RAG system that integrates text and images with LLMs and Embedding model, built using LangChain, ChromaDB and Streamlit.
...
- **Groq LLM API (Open Source)**: Groq's AI models 
...
1. **Configure Models & Parameters**
   ...
   **🤖 Model Selection:**
   - **Main LLM Model**: Choose from different LLMs
